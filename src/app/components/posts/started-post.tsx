...
const StartedPost = () => {
  ...
  return (
    <div className="w-full h-fit md:h-70 bg-slate-50 flex flex-col items-center justify-between">
      {/* top */}
      <div className="px-3 w-full h-12 text-lg text-white bg-red-500 flex items-center">
      ...
      <div className="w-full h-fit min-h-36 px-3 flex flex-row items-center my-2">
        ...
        <div className="w-[66%] h-full md:w-64 min-h-36 bg-slate-50 px-6 flex flex-col items-start justify-around">
          <div className="">
      ...
      {/* progress bar */}
      <div className="w-full h-[15%] px-3 min-h-8 flex flex-ro items-center justify-between gap-2 font-mono">
        <div className="text-sm text-slate-400">Progress</div>
        <div className="w-full bg-slate-200 rounded-sm h-2.5">
          <div
            className="bg-red-900 h-2.5 rounded-sm"
            style={{ width: "0%" }}
          ></div>
        </div>
      ...
      <div className="bg-gray-200 text-red-500 w-full h-8 flex flex-row items-center justify-between text-center text-sm cursor-pointer font-mono">
        ...
        {/* comment button */}
        <div className="h-full w-1/3 flex items-center justify-center border-r-2 border-slate-50 gap-2 hover:text-red-800">
